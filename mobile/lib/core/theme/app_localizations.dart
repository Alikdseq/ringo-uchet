...
class AppLocalizations {
  ...
  // Общие
  String get appName =>
      _localizedValues[locale.languageCode]?['appName'] ?? 'Ringo Uchet';
  ...
  String get orderStatusDraft =>
      _localizedValues[locale.languageCode]?['orderStatusDraft'] ?? 'Draft';
  String get orderStatusCreated =>
      _localizedValues[locale.languageCode]?['orderStatusCreated'] ?? 'Created';
  String get orderStatusApproved =>
      _localizedValues[locale.languageCode]?['orderStatusApproved'] ??
      'Approved';
  String get orderStatusInProgress =>
      _localizedValues[locale.languageCode]?['orderStatusInProgress'] ??
      'In Progress';
  String get orderStatusCompleted =>
      _localizedValues[locale.languageCode]?['orderStatusCompleted'] ??
      'Completed';
  String get orderStatusCancelled =>
      _localizedValues[locale.languageCode]?['orderStatusCancelled'] ??
      'Cancelled';
